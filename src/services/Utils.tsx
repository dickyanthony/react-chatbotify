...
export const defaultFlow: Flow = {
  start: {
    message:
      "Hello, I am Dicky Anthony 👋! Welcome to React ChatBotify, I'm excited that you are using our " +
      'chatbot 😊!',
...
export const isDesktop = !/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
  navigator.userAgent
);
